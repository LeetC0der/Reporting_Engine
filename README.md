...
- Stateful UX: UI state persisted in Node.js (navigation, toggle, form, theme) and restored after reload
- Theme: light theme by default, user-switchable in Settings
...
- Server-managed UI state rehydration on refresh (navigation, form, toggle, and theme)
